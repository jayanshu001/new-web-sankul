...
export const createAudioNote = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error("createAudioNote failed", { userId, error: getErrorMessage(err) });
...
export const listAudioNotes = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error("listAudioNotes failed", { userId, error: getErrorMessage(err) });
    return failure(res, getErrorMessage(err), 500);
  }
};
...
export const updateAudioNote = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (!note) return failure(res, "Audio note not found.", 404);
    ...
    logger.error("updateAudioNote failed", { userId, error: getErrorMessage(err) });
    return failure(res, getErrorMessage(err), 500);
  }
};
...
export const deleteAudioNote = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error("deleteAudioNote failed", { userId, error: getErrorMessage(err) });
    return failure(res, getErrorMessage(err), 500);
  }
};
