...
// Role is compulsory when creating an administrator; optional on update.
const requiredRoleField = roleValue;
const roleField = roleValue.optional().nullable();
