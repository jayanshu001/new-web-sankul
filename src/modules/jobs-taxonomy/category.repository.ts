...
export const categoryRepository = {
  ...
  count: (search?: string, organizationId?: bigint) => prisma.jobCategory.count({ where: buildWhere(search, organizationId) }),

  findById: (id: bigint) => prisma.jobCategory.findUnique({ where: { id }, include: { organization: true } }),
