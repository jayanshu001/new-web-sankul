...
All five Prisma models already exist. **No module is wired or flagged yet** — every consumer uses Mongoose. — ✅ DONE (superseded; see banner) · all offline modules now on MySQL, flags ON
